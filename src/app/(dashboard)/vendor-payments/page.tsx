...
export default function VendorPaymentsPage() {
  ...
  useEffect(() => {
    const savedView = localStorage.getItem("vendorPaymentsViewMode");
  ...
  const changeViewMode = (mode: "list" | "grid") => {
    setViewMode(mode);
    localStorage.setItem("vendorPaymentsViewMode", mode);
  };
                    ...
                    >
                      ...
                      <td className="py-3 px-3">
                        <div className="flex items-center gap-2">
                          <Truck className="h-3.5 w-3.5 text-red-500 flex-shrink-0" />
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    payment? The vendor's balance will be
                                    affected.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  The vendor's balance will be affected.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancel</AlertDialogCancel>
