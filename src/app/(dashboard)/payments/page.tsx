      ...
      {loading ? (
        ...
        searchTerm || methodFilter !== "all" ? (
          <EmptyState
            ...
            description={`We couldn't find any payments matching "${
          ...
          <EmptyState
            ...
            description="Record your first payment to get started. Payments will appear here with their method, date and amount."
